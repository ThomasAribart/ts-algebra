...
/**
 * Return `true` if the provided `Object` meta-type is defined to be resolved as a closed object
 * @param META_OBJECT ObjectType
 * @returns Boolean
 */
export type ObjectCloseOnResolve<META_OBJECT extends ObjectType> =
...
> = If<
  ...
  DeepMergeUnsafe<
    If<
      ObjectCloseOnResolve<META_OBJECT>,
      {},
      If<
